 ...
 * 
 * Edited for Rekt Slideshow by Paul Cushing
...
$src_querystring = get_request ('src', '');
$enc_picfile = urldecode($src_querystring);
$src = base64_decode($enc_picfile);
if ($src == '' || strlen ($src) <= 3) {
...
function display_error ($errorString = '') {
	...
	echo '<br />Picksize version : ' . VERSION . '</pre>';
    die ();
